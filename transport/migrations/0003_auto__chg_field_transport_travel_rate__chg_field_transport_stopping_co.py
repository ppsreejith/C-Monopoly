...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transport.travel_rate'
        db.alter_column(u'transport_transport', 'travel_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=5))

        # Changing field 'Transport.stopping_cost'
        db.alter_column(u'transport_transport', 'stopping_cost', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=5))

    def backwards(self, orm):

        # Changing field 'Transport.travel_rate'
        db.alter_column(u'transport_transport', 'travel_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2))

        # Changing field 'Transport.stopping_cost'
        db.alter_column(u'transport_transport', 'stopping_cost', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=2))
    ...
    models = {
        ...
        u'transport.transport': {
            ...
            'stopping_cost': ('django.db.models.fields.DecimalField', [], {'max_digits': '9', 'decimal_places': '5'}),
            'travel_rate': ('django.db.models.fields.DecimalField', [], {'max_digits': '9', 'decimal_places': '5'})
        },
