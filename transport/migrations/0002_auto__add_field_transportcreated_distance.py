...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransportCreated.distance'
        db.add_column(u'transport_transportcreated', 'distance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TransportCreated.distance'
        db.delete_column(u'transport_transportcreated', 'distance')
