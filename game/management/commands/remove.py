...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if every or 'states' in args:
            ...
            ProductIndustry.objects.filter(name__startswith = nameDef+"sf" ).delete()
            ProductIndustry.objects.filter(name__startswith = nameDef+"mf" ).delete()
            ProductIndustry.objects.filter(name__startswith = nameDef+"bf" ).delete()
            EnergyIndustry.objects.filter(name__startswith = nameDef+"sp" ).delete()
            EnergyIndustry.objects.filter(name__startswith = nameDef+"mp" ).delete()
            EnergyIndustry.objects.filter(name__startswith = nameDef+"bp" ).delete()
