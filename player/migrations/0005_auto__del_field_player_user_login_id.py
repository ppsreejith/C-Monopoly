...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Player.user_login_id'
        db.delete_column(u'player_player', 'user_login_id')


    def backwards(self, orm):
        # Adding field 'Player.user_login_id'
        db.add_column(u'player_player', 'user_login_id',
    ...
    models = {
        ...
        u'player.player': {
            ...
            'rank': ('django.db.models.fields.PositiveIntegerField', [], {'default': '101', 'unique': 'True'}),
