...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Player', fields ['rank']
        db.delete_unique(u'player_player', ['rank'])


    def backwards(self, orm):
        # Adding unique constraint on 'Player', fields ['rank']
        db.create_unique(u'player_player', ['rank'])
    ...
    models = {
        ...
        u'player.player': {
            ...
            'rank': ('django.db.models.fields.PositiveIntegerField', [], {'default': '101'}),
