...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductIndustry.carbon_per_unit'
        db.alter_column(u'industry_productindustry', 'carbon_per_unit', self.gf('django.db.models.fields.DecimalField')(max_digits=15, decimal_places=5))

    def backwards(self, orm):

        # Changing field 'ProductIndustry.carbon_per_unit'
        db.alter_column(u'industry_productindustry', 'carbon_per_unit', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=5))
