...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'industry_factory', (
            ...
            ('transport', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['transport.TransportCreated'], null=True, blank=True)),
            ...
            ('products_last_month', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
