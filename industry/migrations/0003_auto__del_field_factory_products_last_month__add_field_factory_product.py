...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Factory.products_last_month'
        db.delete_column(u'industry_factory', 'products_last_month')

        # Adding field 'Factory.products_last_day'
        db.add_column(u'industry_factory', 'products_last_day',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Factory.products_last_month'
        db.add_column(u'industry_factory', 'products_last_month',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Factory.products_last_day'
        db.delete_column(u'industry_factory', 'products_last_day')
