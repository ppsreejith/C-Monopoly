...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'industry_loanscreated', (
        ...
        db.send_create_signal(u'industry', ['LoansCreated'])

        # Adding M2M table for field mortaged_industries on 'LoansCreated'
        m2m_table_name = db.shorten_name(u'industry_loanscreated_mortaged_industries')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('loanscreated', models.ForeignKey(orm[u'industry.loanscreated'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'industry_loanscreated')

        # Removing M2M table for field mortaged_industries on 'LoansCreated'
        db.delete_table(db.shorten_name(u'industry_loanscreated_mortaged_industries'))
